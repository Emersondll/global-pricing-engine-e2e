@ok
Feature: I want to be able to validate the deals new firstOrder filter

  Scenario Outline:  pricing-engine DealsV2 filter by firstOrder
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Scenarios:
      ...
      | BR      | 7a51f522-c3e3-421b-89d8-290d8eb2eddd | deals-v3-request-first-order-filter-true          | deals-v2-response-first-order-filter               | BR-deals-v3-first-order-data-ingestion       | COUPON |
