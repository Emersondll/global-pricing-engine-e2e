@ignore
Feature: I want to get the deals v2 Cross Discounts
  ...
  Scenario Outline: Validate retrieve deals v2 through pricing-engine endpoint (including prices with taxes.proportional true)
    ...
    * I have the "timezone" header with value "<timezone>"
    * I have the x-timestamp header with current time
    * I have the requestTraceId header with value starting with a "e2e-put-deal-cross-discounts"
    * I set the token to the vendorId "<vendorId>"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    # GET Deals POST method
    Given I have the "country" header with value "<country>"
    * I have the "timezone" header with value "<timezone>"
    * I have the requestTraceId header with value starting with a "e2e-get-deals"
    * I have the payload at file "<deal-v3-request>" at folder "deal-service"
    * I set the token to the vendorId "<vendorId>"
    ...
    Given I have the payload at file "<deal-v2-cross-discounts-file-name>" at folder "pricing-engine"
    * I have the "country" header with value "<country>"
    * I have the "timezone" header with value "<timezone>"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Then The response code is "200" and the body matches the json at file "<deal-v2-cross-discounts-file-name>" at folder "pricing-engine"

    Scenarios:
      | country | timezone          | vendorId                             | price-file-name                      | price-request-file-name                    | account-file-name             | deal-file-name          | deal-v3-request                         | deal-v2-cross-discounts-file-name |
      | BR      | America/Sao_Paulo | eafe490e-fddc-4b01-900a-d0dc45194ab6 | br-prices-v3-deals-v2-cross-discount | br-v3-post-request-deals-v2-cross-discount | br-account-deals-v2-for-score | br-deals-cross-discount | br-deals-v3-post-request-cross-discount | br-deals-v2-cross-discount        |
