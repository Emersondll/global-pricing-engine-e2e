@ignore
Feature: I want to get the deals v2 available and yours Metadata

  Scenario Outline: Validate retrieve deals v2 through pricing-engine endpoint
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    # PUT Promotion
    Given I have the payload at file "<promotion-file-name>" at folder "promotion-service"
    * I have the "country" header with value "<country>"
    * I have the x-timestamp header with current time
    * I have the requestTraceId header with value starting with a "e2e-put-promotion"
    * I set the token to the vendorId "<vendorId>"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Then The response code is "200" and the body matches the json at file "<price-file-name>" at folder "price-service"
     ...
     # GET Deals with Metadata through POST method
    Given I have the "country" header with value "<country>"
    * I have the "timezone" header with value "<timezone>"
    * I have the requestTraceId header with value starting with a "e2e-get-deals"
    * I have the "projection" header with value "METADATA"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    # GET Deal V2 with metadata through pricing-engine
    Given I have the payload at file "<deal-v2-metadata-file-name>" at folder "pricing-engine"
    * I have the "country" header with value "<country>"
    * I have the "timezone" header with value "<timezone>"
    * I have the "projection" header with value "METADATA"
    * I have the "accept-language" header with value "pt-BR"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Then The response code is "200" and the body matches the json at file "<deal-v2-metadata-file-name>" at folder "pricing-engine"

    Scenarios:
      | country | timezone          | vendorId                             | price-file-name                | price-request-file-name                    | account-file-name   | promotion-file-name   | deal-file-name         | deal-request-file-name            | deal-v2-metadata-file-name | vendorId_ambev                       |
      | BR      | America/Sao_Paulo | eafe490e-fddc-4b01-900a-d0dc45194ab6 | br-prices-v3-deals-v2-metadata | br-v3-deals-v2-metadata-request-contractId | br-account-deals-v2 | br-18674-promotion-v3 | br-deals-with-metadata | br-request-deals-v3-with-metadata | br-deals-v2-metadata       | 7a51f522-c3e3-421b-89d8-290d8eb2eddd |
