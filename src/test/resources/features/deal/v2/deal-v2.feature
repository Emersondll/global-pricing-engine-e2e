...
Feature: I want to get the deals v2 available for a customer
  ...
  Scenario Outline: Validate retrieve deals v2 through pricing-engine endpoint (including prices with taxes.proportional true)
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    # PUT Deal
    Given I have the payload at file "<deal-v3-request>" at folder "deal-service"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Scenarios:
      | country | timezone          | vendorId                             | price-file-name       | price-request-file-name           | account-file-name   | deal-v3-request      | deal-v2-file-name | vendorId_ambev                       |
      | BR      | America/Sao_Paulo | eafe490e-fddc-4b01-900a-d0dc45194ab6 | br-prices-v3-deals-v2 | br-v3-deals-v2-request-contractId | br-account-deals-v2 | br-deals-v2-deals-v2 | br-deals-v2       | 7a51f522-c3e3-421b-89d8-290d8eb2eddd |
