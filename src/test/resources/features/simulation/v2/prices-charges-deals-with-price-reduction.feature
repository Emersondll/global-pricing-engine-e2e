@ok
Feature: I want to be able to validate prices, charges and deals with price reduction

  Scenario Outline: Validate prices, charges and deals with price reduction
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Scenarios:
      ...
      | BR      | d8e9fbc3-0678-4778-beb7-74165906d3fa | America/Sao_Paulo | br-price-v3-price-reduction | br-charges-v3-price-reduction | br-deals-v3-line-item-price-reduction | br-price-v3-request-price-reduction | br-price-v3-price-reduction | br-request-charges-v3-price-reduction | br-charges-v3-price-reduction | br-request-deals-line-item-price-reduction | br-deals-v3-line-item-price-reduction | br-simulation-v2-price-reduction | br-simulation-v2-line-item-price-reduction |