@ok
Feature: I want to be able to validate the Simulation price with Interest, Deal and Charge with the new charge calculation

  Scenario Outline: Simulation V2 with prices with taxes and charges and deals and charges v3 with new charge calculation
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    # Simulation
    Given I have the payload at file "mx-simulation-v2-request-new-charge-calculation" at folder "pricing-engine"
    * I have the "country" header with value "<country>"
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Then The response code is "200" and the body matches the json at file "mx-simulation-v2-response-new-charge-calculation" at folder "pricing-engine"

    Scenarios:
      | country | vendorId                             | timezone            | price-relay-request                         | price-api-request                           | price-api-response                           | deal-relay-request                        | deal-api-request                           | deal-api-response                            | charge-relay-request                                                               | charge-api-request                                        | charge-api-response                                                         |
      | MX      | 7289d6e3-ea3b-4a23-904f-61e5b3e5c0b7 | America/Mexico_City | mx-create-prices-v3-new-charges-calculation | mx-request-prices-v3-new-charge-calculation | mx-response-prices-v3-new-charge-calculation | mx-create-deals-v3-new-charge-calculation | mx-request-deals-v3-new-charge-calculation | mx-response-deals-v3-new-charges-calculation | mx-charges-v3-create-payment-method-fee-scope-line-item-for-new-charge-calculation | mx-charges-v3-post-request-request-new-charge-calculation | mx-charges-v3-payment-method-fee-scope-line-item-for-new-charge-calculation |
