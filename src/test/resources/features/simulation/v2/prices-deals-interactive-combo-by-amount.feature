@ok
Feature: I want to be able to call simulation in pricing-engine/v2, with deal interactive combo by amount

  Scenario Outline: Simulation V2 with deal multiplelineitem by amount ( aka deal interactive combo by amount )
    ...
    * I set the token to the vendorId "<vendorId>"
    ...
    Scenarios:
      ...
      | BR      | America/Sao_Paulo | 3c5eece4-ac37-44e3-a95e-a264802a7dfe | br-create-prices-v3-interactive-combo-by-amount  | br-request-prices-v3-interactive-combo-by-amount | br-response-prices-v3-interactive-combo-by-amount | br-create-deals-v3-interactive-combo-by-amount  | br-request-deals-v3-interactive-combo-by-amount | br-response-deals-v3-interactive-combo-by-amount  | br-simulation-v2-request-interactive-combo-by-amount  | br-simulation-v2-response-interactive-combo-by-amount |
